...
import { TRACE_BRIDGED_COLOR, TRACE_FORWARD_COLOR, hexToCSS } from "../../config";
...
describe("drawLinks traced path", () => {
  it("draws measured segments dashed in the flow color and bridged ones dotted in their own", () => {
