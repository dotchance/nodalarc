...
/**
 * Icon artwork extracted from Lucide (https://lucide.dev), ISC license —
 * see THIRD_PARTY_NOTICES.md and LICENSES/Lucide-ISC.txt. Generated from
 * lucide-static; bodies render inside the standard 24x24 stroke wrapper in
 * Icon.tsx (stroke = currentColor, so icons follow the text color slot).
 * Add icons by appending the Lucide SVG body here — keep names = Lucide names.
 */
...
export const ICON_BODIES = {
  ...
  "folder-open":
    '<path d="m6 14 1.45-2.9A2 2 0 0 1 9.24 10H20a1 1 0 0 1 .97 1.24l-1.4 5.7A2 2 0 0 1 17.35 19H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h3.93a2 2 0 0 1 1.66.9l.82 1.2a2 2 0 0 0 1.66.9H18a2 2 0 0 1 2 2v2" />',
  "save":
