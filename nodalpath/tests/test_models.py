...
from nodalpath.models.almanac import AlmanacEntry, ForwardingTable, IngressRule, LabelBinding
    ...
    def test_round_trip(self):
        path = ComputedPath(
            ...
            hops=[
                ...
                PathHop(
                    node_id="gs-beta", node_type="ground_station", sid=24001, in_interface="gnd0"
                ),
            ],
...
class TestLabelBinding:
    ...
    def test_reject_invalid_action(self):
        with pytest.raises(ValueError, match="action must be"):
            LabelBinding(in_label=16001, action="drop", out_label=16002, out_interface="isl0")


class TestIngressRule:
    def test_round_trip(self):
        rule = IngressRule(dst_prefix="172.16.1.0/24", push_label=16001, out_interface="gnd0")
